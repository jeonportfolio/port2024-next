...
export const portText = [
    {
        num: "01",
        title: "웹디자인기능사 공부 사이트 (PC화면)",
        desc: "피그마 & HTML & CSS를 웹디자인기능사 기술을 활용한 사이트입니다. 저의 웹디자인기능사 공부법을 공유하였습니다.",
        img: port01,
        code: "https://jeonportfolio.github.io/FIGMA-WEB/figma%20portfolio.html",
    ...
    },
    {
        ...
        desc: "REACT를 활용해 나만의 자기개발 관련 카테고리를 구성한 유튜브 사이트 입니다.RAPID API를 사용해 검색과 영상재생이 가능합니다. ",
        img: port02,
